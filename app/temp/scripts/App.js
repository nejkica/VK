...
var _izdelajTabelo = __webpack_require__(25);

var _izdelajTabelo2 = _interopRequireDefault(_izdelajTabelo);
...
var Ajax = function () {
	function Ajax() {
		...
		this.maxPodobnostSklop = (0, _jquery2.default)('.razlaga__odstotek-sklop');
		this.maxPodobnostObcina = (0, _jquery2.default)('.razlaga__odstotek-obcina');
		this.maxPodobnostProjekt = (0, _jquery2.default)('.razlaga__odstotek-projekt');

		this.maxCenaSklop = (0, _jquery2.default)('.razlaga__cena-sklop');
		this.maxCenaObcina = (0, _jquery2.default)('.razlaga__cena-obcina');
		this.maxCenaProjekt = (0, _jquery2.default)('.razlaga__cena-projekt');

		this.avgCenaSklop = (0, _jquery2.default)('.razlaga__povprecje-sklop');
		this.avgCenaObcina = (0, _jquery2.default)('.razlaga__povprecje-obcina');
		this.avgCenaProjekt = (0, _jquery2.default)('.razlaga__povprecje-projekt');
	...
	_createClass(Ajax, [{
		...
		key: 'vnesiVtabelo',
		value: function vnesiVtabelo(trgt) {
...
// var izdelajTabelo = new IzdelajTabelo();
